...
_pipeline = Pipeline.from_pretrained("pyannote/speaker-diarization-3.1", use_auth_token=_HF_TOKEN)
if torch.cuda.is_available():
    _pipeline.to(torch.device("cuda"))
_embedder = Inference("pyannote/embedding", window="whole", use_auth_token=_HF_TOKEN)
