...
class FakeInference:
    ...
    def push_chat(self, obj):
        self.chat.append(obj)

    def push_raw(self, body):
        self.raw.append(body)  # sent verbatim, no envelope

    def push_transcription(self, obj):
        self.transcriptions.append(obj)

    def push_error(self, status):
        ...
        class H(BaseHTTPRequestHandler):
            ...
            def do_POST(self):
                ...
                if self.path.endswith("/chat/completions"):
                    ...
                    body = (
                        outer.transcriptions.popleft() if outer.transcriptions else {"segments": []}
                    )
                else:
